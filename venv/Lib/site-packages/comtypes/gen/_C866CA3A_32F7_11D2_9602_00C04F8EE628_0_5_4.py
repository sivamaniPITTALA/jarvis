...
__all__ = [
    'DISPID_SASetState', 'SDA_Consume_Leading_Spaces',
    'SpeechStreamFileMode', 'DISPID_SPRsCount',
    'ISpPhoneticAlphabetSelection',
    'SpeechPropertyNormalConfidenceThreshold', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPEAudioSizeTime', 'SpMMAudioEnum',
    'DISPID_SRRAudioFormat', 'DISPID_SGRsFindRule',
    '_RemotableHandle', 'SVP_16',
    'DISPID_SPANumberOfElementsInResult', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechAudio', 'SRERequestUI', 'SP_VISEME_16', 'SASStop',
    'SpeechPropertyAdaptationOn', 'DISPID_SWFEBlockAlign',
    'SpObjectTokenCategory', 'SPPHRASEELEMENT',
    'SpeechGrammarWordType', 'SPGS_ENABLED', 'SPEI_UNDEFINED',
    'ISpObjectToken', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechPhraseReplacement', 'SRTReSent', 'DISPID_SPPParent',
    'DISPID_SOTRemove', 'IEnumSpObjectTokens', 'DISPID_SLWLangId',
    'SPVPRI_NORMAL', 'DISPID_SpeechPhraseElement',
    'SPPS_Interjection', 'SPPS_Function', 'SPEI_SENTENCE_BOUNDARY',
    'SECFIgnoreCase', 'DISPID_SPCPhoneToId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SRARoot', 'SP_VISEME_14',
    'DISPID_SVVoice', 'SPRULESTATE', 'DISPID_SAStatus',
    'DISPID_SAFSetWaveFormatEx', 'SpeechStreamSeekPositionType',
    'DISPID_SPEDisplayText', 'SPEVENTENUM', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechVoiceEvent', 'SpCustomStream', 'SPAR_High',
    'SP_VISEME_9', 'DISPID_SAVolume', 'SVSFIsFilename',
    'DISPID_SRDisplayUI', 'DISPID_SRCESoundEnd',
    'DISPIDSPTSI_ActiveLength', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechGrammarRuleState', 'SPVOICESTATUS', 'SP_VISEME_18',
    'DISPID_SpeechPhraseReplacements', 'SBONone', 'SPEI_RESERVED2',
    'DISPID_SLWsCount', 'ISpResourceManager', 'SPSLMA',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRGetRecognizers', 'SPSHT_OTHER',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVGetAudioInputs',
    'DISPID_SVGetProfiles', 'LONG_PTR', 'SAFTADPCM_11kHzStereo',
    'SAFTGSM610_11kHzMono', 'SPFM_CREATE_ALWAYS', 'SDTRule',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechInterference',
    'DISPID_SADefaultFormat', 'DISPID_SPIAudioStreamPosition',
    'SPSVerb', 'SASClosed', 'SDKLCurrentConfig', 'SINoSignal',
    'eLEXTYPE_PRIVATE1', 'SVSFIsNotXML', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE6', 'SVP_11', 'SDA_No_Trailing_Space',
    'SPDKL_LocalMachine', 'eWORDTYPE_ADDED', 'SVEStartInputStream',
    'DISPID_SOTGetDescription', 'DISPID_SRCPause',
    'SpeechCategoryVoices', 'DISPID_SDKEnumKeys', 'DISPID_SGRClear',
    'SVP_9', 'STCInprocHandler', 'SRTSMLTimeout',
    'SpeechVoicePriority', 'SpFileStream', 'SVP_5',
    'eLEXTYPE_RESERVED4', 'SP_VISEME_7', 'SpeechTokenContext',
    'STCRemoteServer', 'SpeechRuleState', 'SpeechWordType',
    'DISPID_SDKSetStringValue', 'SpeechGrammarTagUnlimitedDictation',
    'Speech_StreamPos_Asap', 'SAFT32kHz16BitStereo',
    'DISPID_SPIReplacements', 'SGDisplay', 'SWTAdded', 'SP_VISEME_11',
    'SRERecoOtherContext', 'ISpeechTextSelectionInformation',
    'SRESoundEnd', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechRecognizer', 'SECFIgnoreWidth',
    'DISPID_SRCSetAdaptationData', 'SPSNotOverriden',
    'DISPID_SVAudioOutput', 'DISPID_SBSWrite', 'DISPID_SPAsItem',
    'DISPID_SGRsCount', 'SpeechAllElements', 'ISpeechObjectToken',
    'DISPID_SRCESoundStart', 'DISPID_SOTCGetDataKey', 'ISpAudio',
    'SRSActiveAlways', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCERecognitionForOtherContext', 'SRESoundStart',
    'SVP_10', 'DISPID_SVSVisemeId', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRSCurrentStreamPosition', 'SPAUDIOSTATUS',
    'SPSHORTCUTTYPE', 'SAFT11kHz16BitMono', 'ISpeechGrammarRules',
    'DISPID_SLWsItem', 'SAFT32kHz16BitMono', 'eLEXTYPE_USER',
    'SPCS_DISABLED', 'SPEI_MIN_TTS', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechGrammarRules', 'SPPS_RESERVED3',
    'Speech_Default_Weight', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SVGetAudioOutputs',
    'SPDKL_CurrentUser', 'DISPID_SpeechLexiconWords',
    'SPCT_SUB_DICTATION', 'SDTAll', 'SpeechRuleAttributes', 'SVP_12',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_1', 'ISpeechRecoResult2',
    'ISpeechGrammarRuleState', 'DISPID_SGRId', 'DISPID_SMSALineId',
    'DISPID_SRRAudio', 'SAFT24kHz16BitStereo',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGDictationSetState', 'SPSNoun',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRADefaultToActive',
    'DISPID_SPILanguageId', 'eLEXTYPE_APP', 'SVSFNLPMask',
    'DISPID_SRGState', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_PRIVATE16', 'SPPS_SuppressWord', 'ISpeechGrammarRule',
    'DISPID_SPPs_NewEnum', 'ISpeechWaveFormatEx', 'ISpeechFileStream',
    'DISPID_SGRSTNextState', 'SpeechRecoEvents',
    'SpeechCategoryRecognizers', 'SLTUser', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechPhraseInfo', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechLexicon', 'DISPID_SVSInputWordPosition',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRsCommitAndSave',
    'SVEWordBoundary', 'SPAR_Low', 'DISPID_SASNonBlockingIO',
    'SREStreamStart', 'SREAdaptation', 'ISpRecognizer3',
    'SAFT8kHz8BitStereo', 'SVP_3', '_ISpeechVoiceEvents',
    'SpeechRetainedAudioOptions', 'SLOStatic', 'DISPID_SOTCSetId',
    'DISPID_SGRAddState', 'DISPID_SLGetWords',
    'ISpeechPhraseAlternate', 'SpeechGrammarRuleStateTransitionType',
    'SVPNormal', 'DISPID_SGRsCommit', 'DISPID_SVEVoiceChange',
    'SPBINARYGRAMMAR', 'DISPID_SLPLangId',
    'DISPID_SRSetPropertyNumber', 'SPVPRI_OVER',
    'DISPID_SRCEEndStream', 'ISpLexicon',
    'DISPID_SRCEPropertyStringChange', 'SPEI_RECO_STATE_CHANGE',
    'SPRULE', 'ISpeechPhraseElements', 'ISpeechCustomStream',
    'SSFMOpenForRead', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_RESERVED6', 'SpeechRunState', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    '__MIDL_IWinTypes_0009', 'SAFT8kHz16BitMono',
    'DISPID_SVSCurrentStreamNumber', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SLPsCount', 'SDTLexicalForm', 'SPGRAMMARSTATE',
    'SPPS_NotOverriden', 'ISpDataKey', 'DISPID_SVEWord',
    'DISPID_SRGCmdSetRuleState', 'SRCS_Disabled',
    'SPSTREAMFORMATTYPE', 'SpStreamFormatConverter',
    'DISPID_SWFESamplesPerSec', 'SpeechDiscardType',
    'DISPID_SWFEBitsPerSample', 'SpeechAudioProperties',
    'DISPID_SRGDictationUnload', 'SAFT44kHz16BitStereo',
    'SPEI_END_INPUT_STREAM', 'DISPID_SOTDataKey', 'eWORDTYPE_DELETED',
    'DISPID_SLWPronunciations', 'DISPID_SABIEventBias',
    'SPEI_END_SR_STREAM', 'DISPID_SRRGetXMLErrorInfo', 'SRTStandard',
    'DISPID_SVSInputSentencePosition', 'DISPID_SASState',
    'SPAR_Medium', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SABufferInfo',
    'DISPID_SVWaitUntilDone', 'SPWORDTYPE', 'SpeechRecoContextState',
    'SVPAlert', 'tagSTATSTG', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRGCmdLoadFromFile',
    'SSTTTextBuffer', 'DISPID_SGRSAddRuleTransition',
    'SpeechAudioVolume', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechAudioBufferInfo', 'SPAUDIOOPTIONS',
    'DISPID_SLWType', 'DISPID_SOTCreateInstance', 'SFTInput',
    'SECFIgnoreKanaType', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCEBookmark', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVEStreamEnd',
    'SpeechLoadOption', 'SITooFast', 'ISpeechPhraseInfoBuilder',
    'SPWT_DISPLAY', 'SPBO_TIME_UNITS', 'DISPID_SWFEChannels',
    'SVP_21', 'DISPID_SVResume', 'SREAllEvents', 'ISpPhrase',
    'SPSHT_Unknown', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPPId', 'SP_VISEME_2',
    'ISpeechVoiceStatus', 'DISPID_SAEventHandle',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseAlternate', 'SPSHORTCUTPAIRLIST',
    'SpeechPropertyResponseSpeed', 'DISPID_SVPriority',
    'ISpeechPhraseReplacement', 'SAFT48kHz8BitStereo',
    'SGDSActiveUserDelimited', 'SSFMOpenReadWrite', 'SDKLCurrentUser',
    'SPEI_START_SR_STREAM', 'ISpNotifySink', 'SPXRO_SML',
    'DISPID_SPISaveToMemory', 'SPPHRASEPROPERTY', 'SpObjectToken',
    'SAFTADPCM_11kHzMono', 'DISPID_SFSClose', 'SITooSlow',
    'ISpeechResourceLoader', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFT44kHz8BitStereo', 'SP_VISEME_19', 'DISPID_SOTs_NewEnum',
    'SpeechTokenIdUserLexicon', 'SPBO_PAUSE', 'DISPID_SVVolume',
    'SAFT12kHz16BitStereo', 'DISPID_SRRTTickCount',
    'eLEXTYPE_PRIVATE12', 'SPCT_COMMAND', 'eLEXTYPE_RESERVED9',
    'SAFT8kHz16BitStereo', 'SPEI_REQUEST_UI', 'SRAORetainAudio',
    'DISPID_SVSpeakCompleteEvent', 'SWPKnownWordPronounceable',
    'SAFT22kHz8BitMono', 'SINone', 'SAFT16kHz16BitStereo',
    'DISPID_SPAPhraseInfo', 'ISpGrammarBuilder',
    'SAFTCCITT_uLaw_22kHzStereo', 'SSSPTRelativeToEnd', 'SPWORDLIST',
    'SVSFParseSapi', 'ISpeechRecognizerStatus', 'SRERecognition',
    'ISpeechRecoContext', 'DISPID_SPAStartElementInResult',
    'DISPID_SCSBaseStream', 'SPSERIALIZEDRESULT', 'SPCONTEXTSTATE',
    'SPGS_DISABLED', 'SVP_18', 'IInternetSecurityManager',
    'DISPID_SVDisplayUI', 'ISpStream', 'SPCS_ENABLED',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRSTText',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT32kHz8BitStereo',
    'Speech_Max_Pron_Length', '_ISpeechRecoContextEvents',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT11kHz16BitStereo', 'SP_VISEME_12',
    'SVSFPersistXML', 'DISPIDSPTSI_SelectionLength', 'ISpShortcut',
    'eLEXTYPE_PRIVATE4', 'SAFTCCITT_ALaw_44kHzMono', 'SVSFIsXML',
    'DISPID_SGRSTPropertyId', 'SREStreamEnd', 'SPINTERFERENCE',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechDataKey',
    'DISPID_SREmulateRecognition', 'SPFM_NUM_MODES',
    'ISpObjectWithToken', 'SpMMAudioIn', 'SECFNoSpecialChars',
    'DISPID_SMSAMMHandle', 'SPAS_RUN', 'SAFTCCITT_ALaw_8kHzMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechRecoResultTimes', 'SPSFunction',
    'DISPID_SpeechFileStream', 'DISPID_SVSLastResult', 'DISPID_SOTId',
    'DISPID_SVAudioOutputStream', 'SRCS_Enabled',
    'DISPID_SPIRetainedSizeBytes', 'ISpStreamFormat',
    'SVSFNLPSpeakPunc', 'SPRST_ACTIVE', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPRuleParent',
    'DISPID_SLWWord', 'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPEAudioStreamOffset', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSAddWordTransition', 'SAFT11kHz8BitMono',
    'SPRECOSTATE', 'DISPID_SPEPronunciation', 'SPWT_PRONUNCIATION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_19', 'SPEI_MIN_SR',
    'SAFT32kHz8BitMono', 'SPEVENTSOURCEINFO', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE2', 'ISpeechPhraseProperties', 'DISPID_SAFGuid',
    'SGSDisabled', 'SPEI_TTS_BOOKMARK', 'SPEI_VISEME',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVSRunningState',
    'SpTextSelectionInformation', 'DISPID_SpeechLexiconWord',
    'SPPROPERTYINFO', 'SRSEIsSpeaking', 'SpAudioFormat', 'SLODynamic',
    'SP_VISEME_17', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechGrammarRule', 'ISpeechLexiconPronunciations',
    'DISPID_SVSLastBookmark', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCRecognizer', 'SREAudioLevel', 'WAVEFORMATEX',
    'DISPID_SRCAudioInInterferenceStatus', 'SPRST_NUM_STATES',
    'DISPID_SPIGetDisplayAttributes', 'SGRSTTWildcard',
    'SpeechVoiceCategoryTTSRate', 'tagSPTEXTSELECTIONINFO', 'SVPOver',
    'SPBO_NONE', 'SPFM_OPEN_READWRITE', 'SpMemoryStream', 'SASRun',
    'SpMMAudioOut', 'SPINTERFERENCE_TOOFAST', 'SPGRAMMARWORDTYPE',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SAFGetWaveFormatEx',
    'SpSharedRecoContext', 'SPRS_INACTIVE', 'SVP_13',
    'DISPID_SRRPhraseInfo', 'STCAll', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRuleConfidence', 'SPEI_ADAPTATION',
    'DISPID_SpeechMMSysAudio', 'SPPHRASE', 'SAFT11kHz8BitStereo',
    'DISPID_SVAlertBoundary', 'DISPID_SRRTimes',
    'SAFTNoAssignedFormat', 'SPAO_RETAIN_AUDIO', 'SGRSTTTextBuffer',
    'SAFTGSM610_22kHzMono', 'SFTSREngine',
    'DISPID_SRCCmdMaxAlternates', 'SpeechLexiconType',
    'DISPID_SRGRecoContext', 'DISPID_SRRGetXMLResult',
    'DISPID_SRIsUISupported', 'DISPID_SpeechRecoResult2',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTCCITT_uLaw_22kHzMono',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEFalseRecognition',
    'SpeechEngineConfidence', 'SAFT22kHz16BitMono', 'SVSFParseSsml',
    'DISPID_SPACommit', 'DISPIDSPTSI_SelectionOffset', 'SECFDefault',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_6', 'DISPID_SPRText',
    'DISPID_SGRSTWeight', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SOTGetStorageFileName', 'DISPID_SGRsDynamic',
    'SPDKL_CurrentConfig', 'DISPID_SVEStreamStart',
    'DISPID_SPIGetText', 'DISPID_SPIAudioSizeTime',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechAudio',
    'SpeechAudioFormatType', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SSTTDictation', 'SVP_6',
    'SVF_Stressed', 'SPEI_RESERVED3', 'ISpRecognizer',
    'DISPID_SPEsItem', 'DISPID_SRIsShared', 'DISPID_SFSOpen',
    'DISPID_SVEBookmark', 'SPSERIALIZEDPHRASE', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechObjectTokenCategory', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_RESERVED6', 'DISPID_SRGCmdLoadFromObject',
    'SP_VISEME_13', 'SAFT24kHz16BitMono', 'SGRSTTEpsilon',
    'SPPS_Modifier', 'SDTAudio', 'ISpRecoCategory',
    'DISPID_SBSFormat', 'SpNullPhoneConverter',
    'DISPID_SRCERecognition', 'SAFT48kHz16BitMono',
    'ISpeechAudioFormat', 'SPVPRI_ALERT', 'SGLexicalNoSpecialChars',
    'ISpeechDataKey', 'SRSActive', 'SP_VISEME_21',
    'SWPUnknownWordPronounceable', 'SPINTERFERENCE_NOISE',
    'SVSFParseAutodetect', 'SPEVENT', 'DISPID_SWFEFormatTag',
    'DISPID_SVSInputWordLength', 'SAFT16kHz16BitMono',
    'SPEI_RESERVED5', 'DISPID_SPPConfidence', 'SPPS_Noncontent',
    'DISPID_SPERequiredConfidence', 'SDTDisplayText',
    'DISPID_SpeechPhraseProperties', 'SPBOOKMARKOPTIONS',
    'SPBO_AHEAD', 'SDKLDefaultLocation', 'Speech_Max_Word_Length',
    'STSF_FlagCreate', 'DISPID_SPIEngineId',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_3',
    'SAFT24kHz8BitStereo', 'DISPID_SGRsItem', 'SREPropertyNumChange',
    'SP_VISEME_15', 'ISpStreamFormatConverter', 'SPFILEMODE',
    'DISPID_SpeechCustomStream', 'SpeechTokenKeyFiles',
    'ISpeechPhraseProperty', 'DISPID_SGRSTsItem',
    'DISPID_SRRDiscardResultInfo', 'SpeechAddRemoveWord',
    'DISPID_SVIsUISupported', 'DISPID_SRRSetTextFeedback',
    'SRADynamic', 'SpeechFormatType', 'DISPID_SDKDeleteValue',
    'SVP_14', 'DISPID_SVEventInterests', 'SPXMLRESULTOPTIONS',
    'IStream', 'SpPhoneticAlphabetConverter', 'DISPID_SMSSetData',
    'SPPS_LMA', 'DISPID_SLPs_NewEnum', 'SPPHRASERULE',
    'SAFT16kHz8BitMono', 'SpVoice', 'SAFT12kHz8BitMono', 'SRSEDone',
    'DISPID_SVStatus', 'SAFTCCITT_ALaw_22kHzMono', 'SREPrivate',
    'SRSInactiveWithPurge', 'DISPID_SOTDisplayUI', 'DISPID_SRGId',
    'SAFTADPCM_8kHzMono', 'DISPID_SPCIdToPhone', 'SpeechTokenKeyUI',
    'STSF_AppData', 'SREBookmark', 'DISPID_SVEPhoneme',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechVoice', 'SPEI_RESERVED1',
    'DISPID_SPPNumberOfElements', 'tagSPPROPERTYINFO',
    'DISPID_SRRSpeakAudio', 'DISPID_SLAddPronunciation',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechXMLRecoResult',
    'ISpeechLexiconWord', 'SpResourceManager', 'SPAS_CLOSED',
    'DISPID_SOTsItem', 'SPSSuppressWord', 'SRAImport',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPEActualConfidence',
    'ISpMMSysAudio', 'DISPID_SGRName', 'DISPID_SVSpeakStream',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIAudioSizeBytes',
    'SGRSTTDictation', 'SpeechDataKeyLocation', 'SSTTWildcard',
    'DISPID_SpeechBaseStream', 'SSFMCreateForWrite',
    'DISPID_SPRulesItem', 'SPEI_PHRASE_START', 'SPDATAKEYLOCATION',
    'DISPID_SRGReset', 'SPSInterjection', 'SPRST_INACTIVE_WITH_PURGE',
    'SPFM_CREATE', 'eLEXTYPE_RESERVED10', 'STCLocalServer',
    'SPSEMANTICFORMAT', 'SPRECORESULTTIMES', 'SVP_2',
    'DISPID_SRCEPhraseStart', 'SPRST_INACTIVE', 'SRAONone',
    'DISPID_SGRSTransitions', 'DISPID_SPRuleId',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SLPType',
    'IEnumString', 'DISPID_SPIEnginePrivateData', 'SPPS_RESERVED4',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechDisplayAttributes',
    'DISPID_SABIBufferSize', 'DISPID_SPEDisplayAttributes',
    'ISpRecoContext', 'ISpRecoGrammar', 'SGSExclusive',
    'SDA_One_Trailing_Space', 'DISPID_SGRSRule',
    'SAFT12kHz8BitStereo', 'SVP_4', 'SAFT48kHz8BitMono',
    'DISPID_SWFEExtraData', 'ISpRecoContext2', 'SPXRO_Alternates_SML',
    'SpSharedRecognizer', 'SpeechTokenShellFolder',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRStatus',
    'SPEI_TTS_PRIVATE', 'SVSFlagsAsync', 'ISpXMLRecoResult',
    'DISPID_SVPause', 'DISPID_SRCreateRecoContext', 'SRAExport',
    'SRTAutopause', 'SVP_0', 'SVSFDefault', 'DISPID_SPELexicalForm',
    'SPSEMANTICERRORINFO', 'SPLO_DYNAMIC', 'DISPID_SPIGrammarId',
    'SpeechCategoryAudioOut', 'DISPID_SRCRequestedUIType',
    'DISPID_SLPSymbolic', 'DISPID_SABufferNotifySize', 'SVEBookmark',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKGetBinaryValue',
    'DISPID_SMSADeviceId', 'DISPID_SPARecoResult',
    'DISPID_SPEAudioSizeBytes', 'SWTDeleted',
    'SPEI_START_INPUT_STREAM',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPPValue',
    'SP_VISEME_0', 'ISpeechBaseStream', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRSAudioStatus', 'SPPS_Unknown', 'SP_VISEME_8',
    'DISPID_SGRAttributes', 'SpUnCompressedLexicon',
    'SpeechAudioFormatGUIDWave', 'SAFTDefault',
    'SpeechCategoryRecoProfiles', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVSLastBookmarkId', 'SAFT24kHz8BitMono',
    'ISpNotifySource', 'SAFT44kHz16BitMono', 'DISPID_SOTCId',
    'SpeechEmulationCompareFlags', 'DISPID_SRSCurrentStreamNumber',
    'SRTEmulated', 'ISpeechLexiconWords', 'ISpProperties',
    'DISPID_SOTCDefault', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCRetainedAudio', 'ISpSerializeState', 'SP_VISEME_10',
    'SPRECOCONTEXTSTATUS', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechAudioFormat', 'SDTProperty', 'DISPID_SPIStartTime',
    'SpCompressedLexicon', 'UINT_PTR',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCState',
    'DISPID_SVEViseme', 'SPWT_LEXICAL', 'SPLO_STATIC',
    'DISPID_SpeechRecoResult', 'SPPARTOFSPEECH', 'DISPID_SRCVoice',
    'SASPause', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVEAudioLevel', 'SPEI_RECOGNITION', 'ISpeechPhraseRules',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEsCount',
    'DISPID_SpeechPhraseBuilder', 'ISpeechLexiconPronunciation',
    'SITooLoud', 'SAFTText', 'SVSFVoiceMask',
    'DISPID_SOTIsUISupported', 'DISPID_SGRSTsCount',
    'SPEI_SOUND_START', 'SGRSTTWord', 'SAFT22kHz16BitStereo',
    'SPADAPTATIONRELEVANCE', 'SGPronounciation',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechPropertyResourceUsage',
    'SPSHORTCUTPAIR', 'SPWORDPRONOUNCEABLE',
    'SpeechRecoProfileProperties', 'DISPID_SRCEAudioLevel',
    'SPEI_SOUND_END', 'DISPID_SPAsCount', 'ISpObjectTokenCategory',
    'SPEI_SR_BOOKMARK', 'SpeechGrammarTagWildcard',
    'SPEI_INTERFERENCE', 'DISPID_SGRSTPropertyName',
    'ISpNotifyTranslator', 'SECLowConfidence', 'SPPS_RESERVED2',
    'ISpEventSource', 'DISPID_SRRSaveToMemory',
    'ISpeechPhoneConverter', 'SpeechVoiceEvents', 'SPWAVEFORMATTYPE',
    'DISPID_SVEEnginePrivate', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPAS_STOP', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpShortcut',
    'ISpeechRecoResult', 'SREPropertyStringChange',
    'STSF_CommonAppData', 'SPCT_SLEEP', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseRule', 'SPAUDIOSTATE',
    'DISPID_SDKGetStringValue', 'DISPID_SVRate',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLPsItem',
    'DISPID_SRSSupportedLanguages', 'DISPID_SASFreeBufferSpace',
    'SpNotifyTranslator', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechMMSysAudio', 'SAFT22kHz8BitStereo', 'DISPIDSPRG',
    'SAFT44kHz8BitMono', 'SSSPTRelativeToStart', 'SpeechAudioState',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpInProcRecoContext',
    'SpeechPartOfSpeech', 'SREStateChange', 'SVF_Emphasis',
    'DISPID_SPPChildren', 'SpeechUserTraining', 'SPGS_EXCLUSIVE',
    'DISPID_SASCurrentSeekPosition', 'SPEI_FALSE_RECOGNITION',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCBookmark',
    'SpeechRecognitionType', 'SSFMCreate', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SOTCEnumerateTokens', 'SPWORDPRONUNCIATION',
    'DISPID_SVSkip', 'SRAInterpreter', 'DISPID_SpeechAudioStatus',
    'SAFT12kHz16BitMono', 'SVSFUnusedFlags',
    'DISPID_SRGCmdLoadFromResource', 'SpeechDictationTopicSpelling',
    'DISPID_SMSGetData', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechAudioStatus', 'DISPID_SABIMinNotification',
    'eLEXTYPE_PRIVATE13', 'DISPID_SDKSetLongValue',
    'DISPID_SPRulesCount', 'ISpeechGrammarRuleStateTransition',
    'SPEI_VOICE_CHANGE', 'DISPID_SRGCommit', 'DISPID_SGRSTType',
    'eLEXTYPE_PRIVATE18', 'SPWF_SRENGINE', 'DISPID_SRRAlternates',
    'DISPID_SVEAudioLevel', 'SpInprocRecognizer', 'SPVISEMES',
    'DISPID_SPEEngineConfidence', 'ISpeechObjectTokens',
    'SpeechPropertyLowConfidenceThreshold', 'SPINTERFERENCE_NONE',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRGetPropertyNumber',
    'SREInterference', 'DISPID_SBSSeek', 'DISPID_SPPFirstElement',
    'DISPID_SPPName', 'SECNormalConfidence', 'SVSFParseMask',
    'SBOPause', 'SP_VISEME_5', 'DISPID_SPCLangId', 'SPPS_RESERVED1',
    'DISPID_SRCEHypothesis', 'ISpeechVoice', 'DISPID_SRSClsidEngine',
    'ISequentialStream', 'DISPID_SGRInitialState',
    'SPDKL_DefaultLocation', 'DISPID_SLWs_NewEnum', 'ISpVoice',
    'DISPID_SPIElements', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPRFirstElement',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREFalseRecognition', 'DISPID_SLGetPronunciations',
    'SP_VISEME_20', 'DISPID_SRCEventInterests',
    'SpeechCategoryAudioIn', 'SpeechGrammarTagDictation',
    'eLEXTYPE_PRIVATE9', 'SVEPhoneme', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_PRIVATE7', 'DISPID_SDKGetlongValue',
    'SAFTExtendedAudioFormat', 'DISPID_SPIProperties',
    'DISPID_SPPsCount', 'DISPID_SRCEAdaptation', 'SPPS_Noun',
    'DISPID_SRAudioInputStream', 'DISPID_SBSRead',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechVoiceStatus',
    'SAFTADPCM_44kHzStereo', 'SGDSActive',
    'SpeechCategoryAppLexicons', 'SpeechCategoryPhoneConverters',
    'SVP_8', 'SpeechPropertyComplexResponseSpeed', 'SDTReplacement',
    'SpeechBookmarkOptions', 'SpeechRecognizerState',
    'DISPID_SASCurrentDevicePosition', 'SVP_1', 'DISPID_SRAudioInput',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE8', 'SECFEmulateResult',
    'SRTExtendableParse', 'SGDSActiveWithAutoPause',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpRecoResult',
    'SPEI_SR_PRIVATE', 'SDKLLocalMachine', 'DISPID_SPRuleChildren',
    'SREPhraseStart', 'DISPID_SOTCategory',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechSpecialTransitionType',
    'SpWaveFormatEx', 'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPRs_NewEnum',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechRecoResultDispatch',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SOTsCount',
    'DISPID_SGRAddResource', 'SPSModifier', 'ISpeechPhraseRule',
    'SPCT_DICTATION', 'DISPID_SpeechPhraseElements',
    'ISpRecoGrammar2', 'SPSHT_NotOverriden', 'SP_VISEME_4',
    'DISPIDSPTSI', 'DISPID_SAFType', 'DISPID_SGRs_NewEnum',
    'SpPhoneConverter', 'SpeechVisemeType', 'SPRS_ACTIVE',
    'SAFTCCITT_ALaw_11kHzMono', 'SGLexical', 'DISPID_SRCEStartStream',
    'ISpRecognizer2', 'SVEAllEvents', 'DISPID_SPRuleEngineConfidence',
    'SGRSTTRule', 'DISPID_SGRsAdd', 'SDTPronunciation',
    'DISPID_SLPPhoneIds', 'DISPID_SRGetPropertyString',
    'ISpPhraseAlt', 'STCInprocServer', 'SPLOADOPTIONS',
    'DISPID_SRRecognizer', 'SGSEnabled', 'SPWF_INPUT',
    'SpeechGrammarState', 'ISpeechMemoryStream',
    'DISPID_SpeechLexiconPronunciation', 'SRATopLevel', 'SVEPrivate',
    'SPSHT_EMAIL', 'DISPID_SpeechRecoContext',
    'ISpeechPhraseAlternates', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRSetPropertyString', 'SPEI_MAX_TTS',
    'DISPID_SVSInputSentenceLength', 'SGDSInactive',
    'eLEXTYPE_PRIVATE11', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCCreateGrammar', 'DISPID_SRRTStreamTime',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPEAudioTimeOffset', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechTokenKeyAttributes', 'DISPID_SpeechRecoResultTimes',
    'SAFT8kHz8BitMono', 'SPAR_Unknown', 'DISPID_SPIRule',
    'DISPID_SDKSetBinaryValue', 'SVEVoiceChange', 'DISPID_SOTSetId',
    'SVP_20', 'SAFT48kHz16BitStereo', 'SDTAlternates',
    'DISPID_SRProfile', 'DISPID_SPEs_NewEnum', 'SAFTADPCM_22kHzMono',
    'IInternetSecurityMgrSite', 'DISPID_SOTGetAttribute', 'SLTApp',
    'SPEI_MAX_SR', 'SVEViseme', 'DISPID_SDKCreateKey',
    'SpeechWordPronounceable', 'SREHypothesis', 'SPCT_SUB_COMMAND',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCEInterference', 'SPEI_PHONEME',
    'DISPID_SLGetGenerationChange', 'SpLexicon',
    'SVSFPurgeBeforeSpeak', 'SpeechVisemeFeature', 'DISPID_SGRSTRule',
    'SVF_None', 'DISPID_SLGenerationId', 'SDA_Two_Trailing_Spaces',
    'ISpPhoneConverter', 'SpeechRegistryUserRoot',
    'eLEXTYPE_PRIVATE14', 'SINoise', 'DISPID_SVGetVoices',
    'ISpeechRecoGrammar', 'SVP_7', 'SpeechMicTraining', 'SITooQuiet',
    'SAFTADPCM_44kHzMono', 'SRSInactive', 'SpeechEngineProperties',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPERetainedStreamOffset',
    '_SPAUDIOSTATE', 'SVP_15', 'DISPID_SPRNumberOfElements',
    'SpStream', 'DISPID_SRState', 'SPAS_PAUSE', 'DISPID_SRCResume',
    'SPEI_HYPOTHESIS', 'SPFM_OPEN_READONLY', 'SpeechTokenValueCLSID',
    'DISPID_SpeechRecoContextEvents', 'SPVPRIORITY', 'SPLEXICONTYPE',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPRules_NewEnum',
    'DISPID_SVESentenceBoundary', 'SAFTNonStandardFormat',
    'ISpEventSink', 'SVEEndInputStream', 'SPSMF_SAPI_PROPERTIES',
    'SPPS_Verb', 'eLEXTYPE_PRIVATE19', 'SPWORD', 'DISPID_SRRTLength',
    'DISPID_SVSpeak', 'SpPhraseInfoBuilder',
    'DISPID_SPRuleNumberOfElements',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRGetFormat',
    'SPCATEGORYTYPE', 'ISpeechPhraseElement', 'SPSMF_UPS',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechMemoryStream',
    'STSF_LocalAppData', 'DISPID_SPRuleFirstElement',
    'ISpeechPhraseReplacements', 'DISPID_SVSPhonemeId',
    'SECHighConfidence', 'SVP_17', 'DISPID_SRCVoicePurgeEvent',
    'SPSUnknown', 'DISPID_SRRRecoContext', 'SVESentenceBoundary',
    'SpeechVoiceSpeakFlags', 'DISPID_SLPPartOfSpeech',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_RESERVED8', 'ISpeechLexicon',
    'DISPID_SRGRules', 'DISPID_SDKEnumValues', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPRsItem', 'SPAO_NONE', 'DISPID_SpeechObjectTokens',
    'DISPID_SPPsItem', 'DISPID_SRCERequestUI'
]

_check_version('1.1.14', 1662606422.243110)
